  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        <header className="rounded-3xl bg-white/85 p-8 sm:p-12 shadow-sm border border-black/5 space-y-6">
          ...
          <div>
            <h1 className="text-4xl font-black tracking-tight sm:text-5xl" style={{ color: cfg.theme.primary }}>
              {home?.title ?? cfg.name}
            </h1>
            <p className="mt-3 max-w-2xl text-base opacity-80 leading-relaxed">
              {localizedTagline}
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <Link
              href="/news"
              className="rounded-xl bg-white border border-slate-300 px-6 py-3 text-xs font-bold text-slate-800 hover:bg-slate-50 transition"
            >
              Read Daily News 📰
            </Link>
          </div>
